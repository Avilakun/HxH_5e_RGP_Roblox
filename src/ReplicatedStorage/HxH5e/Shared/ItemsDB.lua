...
-- Campos estruturados adicionados (alem do "ca" textual, que fica
-- so pra exibicao na loja): caBase/caDesMax pra calcular a CA real,
-- rd/resistenciaTipos pro dano, ehEscudo (regra de durabilidade
-- diferente -- só quebra com balistico/explosivo/cerco/golpe mirado,
-- nao com qualquer golpe), desvFurtividade, forNecessaria.
-- Durabilidade maxima = caBase (sem contar o bonus de DES), conforme
-- o exemplo do livro (Lucas, doc de durabilidade de equipamentos).
ItemsDB.armaduras = {
	{ nome = "Casaco Reforçado", custo = 130, ca = "11 + DES", peso = 0, slot = "torso",
		caBase = 11, caDesMax = nil, resistenciaTipos = { "Balístico" } },
	{ nome = "Jaqueta de Couro", custo = 300, ca = "11 + DES", peso = 0, slot = "torso",
		caBase = 11, caDesMax = nil, resistenciaTipos = { "Balístico" } },
	{ nome = "Camisa Embutida", custo = 50, ca = "11 + DES", peso = 0, slot = "torso",
		caBase = 11, caDesMax = nil, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Fino de Kevlar", custo = 350, ca = "12 + DES", peso = 0.3, slot = "torso",
		caBase = 12, caDesMax = nil, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Oculto", custo = 500, ca = "12 + DES", peso = 0.5, slot = "torso",
		caBase = 12, caDesMax = nil, resistenciaTipos = { "Balístico" } },
	{ nome = "Escudo Comum", custo = 60, ca = "+1", peso = 1.0, slot = "maoSecundaria",
		ehEscudo = true, caBonus = 1, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Oculto Maior", custo = 560, ca = "13 + DES (max. 2)", peso = 1.0, slot = "torso",
		caBase = 13, caDesMax = 2, rd = 1, rdTipos = { "Corte", "Perfurante" }, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Padrão Kevlar", custo = 1200, ca = "14 + DES (max. 3)", peso = 0, slot = "torso",
		caBase = 14, caDesMax = 3, resistenciaTipos = { "Balístico" } },
	{ nome = "Peitoral Adamantina", custo = 180000, ca = "14 + DES (max. 3)", peso = 0, slot = "torso",
		caBase = 14, caDesMax = 3, resistenciaCritico = true, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Tático", custo = 1500, ca = "15 + DES (max. 2)", peso = 0, slot = "torso",
		caBase = 15, caDesMax = 2, desvFurtividade = true, resistenciaTipos = { "Balístico" } },
	{ nome = "Escudo Tático", custo = 300, ca = "+3", peso = 1.5, slot = "maoSecundaria",
		ehEscudo = true, caBonus = 3, resistenciaTipos = { "Balístico" } },
	{ nome = "Colete Resposta Rápida", custo = 1000, ca = "16", peso = 1.0, requisito = "FOR 14", slot = "torso",
		caBase = 16, caDesMax = 0, desvFurtividade = true, forNecessaria = 14,
		rd = 3, rdTipos = { "Corte", "Perfurante", "Balístico" } },
	{ nome = "Farda de Combate", custo = 2000, ca = "17", peso = 1.0, requisito = "FOR 14", slot = "torso",
		caBase = 17, caDesMax = 0, desvFurtividade = true, forNecessaria = 14,
		rd = 3, rdTipos = { "Corte", "Perfurante", "Balístico" } },
	{ nome = "Farda Op. Especiais", custo = 3500, ca = "18", peso = 1.5, requisito = "FOR 14", slot = "torso",
		caBase = 18, caDesMax = 0, desvFurtividade = true, forNecessaria = 14,
		rd = 5, rdTipos = { "Corte", "Perfurante", "Balístico" } },
	{ nome = "Armadura Adamantina", custo = 200000, ca = "17", peso = 1.0, requisito = "FOR 16", slot = "torso",
		caBase = 17, caDesMax = 0, desvFurtividade = true, forNecessaria = 16, resistenciaCritico = true },
	{ nome = "Escudo Torre Tático", custo = 580, ca = "+5", peso = 3.0, requisito = "FOR 14", slot = "maoSecundaria",
		ehEscudo = true, caBonus = 5, forNecessaria = 14, resistenciaTipos = { "Balístico" } },
}
