-- MonsterDB.lua -- gerado automaticamente a partir do bestiary-data.js
-- do webapp (github.com/Criadores-HxH-5e/Ficha_HxH5e), via conversao JS->JSON->Lua.
-- 53 monstros do Bestiario do Lago Mobius, com stat blocks completos.
--
-- vulneravelAAura: derivado automaticamente da categoria (cat) -- regra do
-- livro ("Feras... normalmente SAO VULNERAVEIS a ataques de Aura"). So
-- "BESTA MAGICA" NAO e vulneravel por padrao; as outras 5 categorias sao.
-- Usado pelo CombatService na regra de critico com aura (ver BasicAttack).

local MonsterDB = {}

MonsterDB.Monstros = {
	{
		nome = "Tartaruga Cabeça de Morango",
		tipo = "Besta Enorme, Neutro/Maligno",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "18 (Defesa Natural)",
		pv = "170 (10d12+5 por nível)",
		desl = "9m",
		for_ = "26 (+8)",
		des = "6 (-2)",
		con = "20 (+5)",
		...
		sab = "14 (+2)",
		car = "10 (+0)",
		pericias = "Atletismo +11, Furtividade +1",
		trs = "For +11, Con +8, Sab +5",
		imunidades = "Agarrado, Derrubado, Impedido",
	...
	{
		nome = "Sapopaciente",
		tipo = "Besta Enorme, Neutro",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "14 (Defesa Natural)",
		pv = "70 (5d12+2)",
		desl = "3m",
		for_ = "10 (+0)",
		des = "15 (+2)",
		...
		sab = "14 (+2)",
		car = "10 (+0)",
		pericias = "Acrobacia +5, Furtividade +5, Percepção +5",
		trs = "Con +6",
		imunidades = "Agarrado, Derrubado",
		sentidos = "Percepção Passiva 12",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Macaco com Cara de Homem",
		tipo = "Besta Mágica Média, Caótico",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "14 (Defesa Natural)",
		pv = "26 (3d10)",
		desl = "9m + 9m Escalada",
		reacoes = "4",
		...
		sab = "14 (+2)",
		car = "16 (+3)",
		pericias = "Atletismo +6, Acrobacia +8, Furtividade +8",
		trs = "For +6, Car +6",
	...
	{
		nome = "Corvo Ventríloquo",
		tipo = "Besta Pequena, Caótico — Bando de 3",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "12 (Defesa Natural)",
		pv = "17 (2d12+5)",
		desl = "9m de Voo",
		reacoes = "2",
		for_ = "2 (-4)",
		...
		sab = "7 (-2)",
		car = "14 (+2)",
		pericias = "Acrobacia +8, Furtividade +8, Enganação +5",
		trs = "Des +8, Car +5",
		imunidades = "Caído",
	...
	{
		nome = "Borboleta Hipnótica",
		tipo = "Besta Mágica Miúda (enxame), Neutro — Bando de 3-5",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "12 (Defesa Natural)",
		pv = "5 (1d4+3)",
		...
		sab = "15 (+2)",
		car = "10 (+0)",
		pericias = "Furtividade +3, Enganação +6",
		imunidades = "Caído, Amedrontado, Enfeitiçado",
		sentidos = "Visão no Escuro 18m",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Fungo Selvagem Claymore",
		tipo = "Planta Miúda, Neutro",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "10 (Defesa Natural)",
		pv = "12",
		desl = "—",
		for_ = "—",
		des = "—",
	...
	{
		nome = "Porco Carimbador",
		tipo = "Besta Média, Maligno — Bandos de 6+",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "16 (Defesa Natural) / 19 (Ponto sensível)",
		pv = "31 (3d8+3 por nível)",
		desl = "9m",
		for_ = "20 (+5)",
		des = "10 (+0)",
		con = "16 (+3)",
		...
		sab = "14 (+2)",
		car = "16 (+3)",
		pericias = "Atletismo +8, Natureza +5, Percepção +5",
		trs = "For +8, Con +6",
		...
		sentidos = "Faro Aguçado, Percepção Passiva 15",
		lingua = "Nenhuma",
		tracos = {},
		acoes = {
	...
	{
		nome = "Urso Negro de Grandes Chifres",
		tipo = "Besta Média/Grande, Maligno",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "18 (Defesa Natural)",
		pv = "39 (4d10+4 por nível)",
		desl = "9m",
		reacoes = "6",
		for_ = "22 (+6)",
		des = "12 (+1)",
		...
		sab = "12 (+1)",
		car = "9 (-1)",
		pericias = "Atletismo +9, Sobrevivência +4",
		trs = "For +9, Con +7",
	...
	{
		nome = "Águia-Aranha",
		tipo = "Besta Mágica Grande, Neutro",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "17 (Defesa Natural)",
		pv = "34 (4d12+1)",
		desl = "9m + 9m Voo",
		for_ = "14 (+2)",
		des = "19 (+4)",
		...
		sab = "18 (+4)",
		car = "8 (-1)",
		pericias = "Acrobacia +7, Furtividade +7, Intuição +7, Sobrevivência +7",
		trs = "Des +7, Sab +7",
		sentidos = "Visão no Escuro 18m, Percepção Passiva 17",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Kiriko",
		tipo = "Besta Mágica Média, Caótico/Neutro",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "15 (Defesa Natural)",
		pv = "25 (3d8+1)",
		desl = "15m + 15m Voo",
		reacoes = "3",
		for_ = "18 (+4)",
		...
		sab = "16 (+3)",
		car = "12 (+1)",
		pericias = "Atletismo +7, Acrobacia +7, Furtividade +7, Enganação +3, Sobrevivência +6",
		trs = "Sab +6",
	...
	{
		nome = "Borboleta Hemotrópica",
		tipo = "Besta Miúda (enxame), Neutra",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "10 (Defesa Natural)",
		pv = "1 (1d4-2)",
		...
		trs = "Con +4",
		sentidos = "Sentidos Aguçados (Olfato)",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Besta Voadora Hexápode",
		tipo = "Besta Mágica Enorme, Maligno",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "16 (Defesa Natural)",
		pv = "45 (4d12+5)",
		desl = "9m",
		reacoes = "2",
		for_ = "24 (+7)",
		...
		sab = "7 (-1)",
		car = "16 (+3)",
		pericias = "Intimidação +6",
		trs = "For +10, Con +6",
		imunidades = "Amedrontado, Surdo",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Parasita Verme Sarapintado",
		tipo = "Besta Miúda Comum, Maligno — Enxame",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "11 (Defesa Natural)",
		pv = "5 (1d8+3)",
		desl = "1m",
		for_ = "4 (-3)",
		des = "11 (+0)",
		...
		imunidades = "Amedrontado, Surdo, Cego, Caído",
		lingua = "Nenhuma",
		tracos = {
	...
	},
	{
		...
		sab = "14 (+2)",
		car = "10 (+0)",
		pericias = "Atletismo +7, Sobrevivência +5, Intimidação +3",
		trs = "For +7, Sab +5",
	...
	{
		nome = "Rei do Pântano",
		tipo = "Besta Grande/Enorme, Neutro",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "16 (Defesa Natural)",
		pv = "39 (3d12+6)",
		...
		sab = "12 (+1)",
		car = "9 (+0)",
		pericias = "Atletismo +8, Sobrevivência +4",
		trs = "Con +10",
		imunidades = "Sangramento (Sistema Hemostático)",
		resistencias = "Cortante, Perfurante (Carapaça de Quitina)",
	...
	{
		nome = "Cobra Gigante de Três Cabeças",
		tipo = "Besta Grande/Enorme, Mau",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "17 (Defesa Natural)",
		pv = "50 (7d10+4)",
		desl = "9m Terrestre, Escalada e Nado",
		for_ = "23 (+6)",
		des = "23 (+6)",
		con = "18 (+4)",
		int_ = "6 (-2)",
		sab = "12 (+1)",
		car = "7 (-2)",
		pericias = "Furtividade +9, Acrobacia +9, Sobrevivência +4, Enganação +1",
		trs = "Des +9, Con +7",
		imunidades = "Sangramento",
		resistencias = "Cortante, Perfurante (Carapaça)",
		sentidos = "Visão às Cegas, Sentidos Aguçados (Olfato)",
		lingua = "Nenhuma",
		tracos = {},
		acoes = {
	...
	{
		nome = "Cavalo Bolha (Bubble Horse)",
		tipo = "Besta de NEN, Médio, Caótico/Neutro",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "15 (Defesa Natural)",
		pv = "15 (2d8+3)",
	...
	{
		nome = "Ciclope Gigante (Primeiro Gigante)",
		tipo = "Besta Mágica/Besta de NEN, Enorme/Imenso, Maligno",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "86 (6d20)",
		desl = "Terrestre padrão",
		for_ = "26 (+8)",
		des = "4 (-3)",
		con = "28 (+9)",
		int_ = "2 (-4)",
		sab = "8 (+0)",
		car = "6 (-2)",
		pericias = "Atletismo +11, Intimidação (com FOR +11)",
		trs = "For +11, Con +12",
		imunidades = "Manipulado/Enfeitiçado, Dano não causado por aura.",
	...
	{
		nome = "Rato Rádio-Ativo",
		tipo = "Besta Mágica/Besta de NEN, Miúdo, Caótico",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "10 (Defesa Natural)",
		pv = "5 (1d4+1)",
		...
		sab = "15 (+2)",
		car = "10 (+0)",
		pericias = "Arcanismo +11, Furtividade +5, Intuição +5",
		trs = "Des +5, Int +11",
	...
	{
		nome = "Hyper Puffball",
		tipo = "Besta Mágica/Besta de NEN, Médio, Caótico/Neutro",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "23 (Armadura Natural)",
		pv = "18 (3d8+2)",
		desl = "15m",
		reacoes = "10",
		for_ = "7 (-2)",
		...
		sab = "18 (+3)",
		car = "10 (+0)",
		pericias = "Acrobacia +13, Intuição +6, Percepção +6, Sobrevivência +6",
		trs = "Des +13, Con +6, Sab +6",
	...
	{
		nome = "Lobos de Matilha",
		tipo = "Besta Mágica/Besta de NEN, Médio, Maligno — Grupo de 3+",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "26 (4d8)",
		...
		sab = "11 (+0)",
		car = "10 (+0)",
		pericias = "Furtividade +4, Percepção +3, Intimidação +3",
		trs = "For +5, Car +3",
		sentidos = "Sentidos Aguçados (Audição e Olfato)",
		lingua = "Comum",
		tracos = {
	...
	{
		nome = "Alfa de Matilha",
		tipo = "Besta Mágica/Besta de NEN, Médio, Maligno",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "35 (5d8+4)",
		...
		sab = "12 (+1)",
		car = "10 (+0)",
		pericias = "Atletismo +7, Furtividade +5, Percepção +4, Intimidação +3",
		trs = "For +5, Des +5",
		sentidos = "Sentidos Aguçados (Audição e Olfato)",
		lingua = "Comum",
		tracos = {
	...
	{
		nome = "Panda Doméstico",
		tipo = "Besta Mágica/Besta de NEN, Médio, Heróico/Neutro",
		cat = "BESTA DE NEN",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "26 (4d6+2 por nível)",
		desl = "9m",
		for_ = "16 (+3)",
		des = "10 (+0)",
		con = "14 (+2)",
		...
		sab = "15 (+2)",
		car = "17 (+3)",
		pericias = "História +7, Religião +7, Intuição +5, Lidar com Animais +5, Percepção +5, Persuasão +6",
		trs = "Int +7, Sab +5, Car +5",
		lingua = "Comum",
		tracos = {
	...
	},
	{
		...
		sab = "10 (+0)",
		car = "16 (+3)",
		pericias = "Arcanismo +7, História +7, Intuição +7, Investigação +7, Percepção +3, Persuasão +6",
		trs = "Int +7",
	...
	{
		nome = "Tigre Acampador",
		tipo = "Besta Média, Maligno",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "14 (Defesa Natural)",
		pv = "52 (10d8+2)",
		...
		sab = "16 (+3)",
		car = "17 (+3)",
		pericias = "Atletismo +12, Sobrevivência +6, Lidar com Animais +6, Intimidação +6",
		trs = "For +12, Des +8",
		sentidos = "Visão no Escuro 18m, Percepção Passiva 16",
		lingua = "Nenhum",
		tracos = {
	...
	{
		nome = "Piko",
		tipo = "Besta Média/Grande, Neutra",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "15 (1d4+5)",
		...
		sab = "12 (+1)",
		car = "10 (+0)",
		pericias = "Atletismo +7, Acrobacia +7",
		trs = "Des +7",
		imunidades = "Exaustão",
		lingua = "Compreende Comum, mas não fala",
		tracos = {
			{ n = "Tração Animal", d = "Capacidade de Carga/Salto dobrada." },
	...
	},
	{
		...
		sab = "22 (+6)",
		car = "18 (+4)",
		pericias = "Atletismo +13, Furtividade +7, Sobrevivência +9, Percepção +9, Intimidação +7",
		trs = "For +13, Des +7, Sab +9",
		imunidades = "Enfeitiçado/Manipulado Mentalmente",
		sentidos = "Visão no Escuro 18m",
	...
	{
		nome = "Pumba Fuça-Suja",
		tipo = "Besta Comum Média, Maligno — Bando de 4",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "22 (3d12+2)",
		...
		trs = "Con, Car",
		imunidades = "Veneno e Envenenado",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Pássaro da Fé",
		tipo = "Besta Pequena, Caótico — Bando de 5",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "15 (Defesa Natural)",
		pv = "12 (1d12+5)",
		...
		sab = "18 (+4)",
		car = "9 (+0)",
		pericias = "Acrobacia +8, Furtividade +8, Intuição +7",
		trs = "Int +3, Sab +7, Des +8",
		imunidades = "Caído, Cego",
		sentidos = "Ecolocalização",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Leãozinho da Inxia",
		tipo = "Besta Comum Média, Neutra",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "14 (Defesa Natural)",
		pv = "25 (3d10+4)",
		...
		sab = "12 (+1)",
		car = "14 (+2)",
		pericias = "Atletismo +7, Furtividade +6, Esquiva +6, Sobrevivência +4",
		trs = "For +7, Des +7",
		sentidos = "Olfato",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Mariposa Poodle",
		tipo = "Besta Mágica Média, Neutra",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "16 (Defesa Natural)",
		pv = "15 (2d6+3)",
		...
		sab = "11 (+0)",
		car = "9 (-1)",
		pericias = "Acrobacia +7, Furtividade +7",
		trs = "Des +7",
		imunidades = "Caído",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Thri-Kreen",
		tipo = "Besta Mágica Média, Neutra — Montarias Desérticas",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "15 (Defesa Natural)",
		pv = "33 (6d8+6)",
		desl = "12m (Salto Parado 6m)",
		reacoes = "4",
		for_ = "12 (+1)",
		des = "15 (+2)",
		con = "13 (+1)",
		...
		sab = "12 (+1)",
		car = "7 (-2)",
		pericias = "Furtividade +5, Percepção +4, Sobrevivência +4",
		imunidades = "Sangramento",
	...
	{
		nome = "Boitatá Adulto",
		tipo = "Besta Mágica Enorme, Caótico/Maligno",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		...
		sab = "11 (+0)",
		car = "7 (-2)",
		pericias = "Acrobacia +8, Lidar com Animais +3, Intimidação +1, Percepção +3",
		trs = "For +3, Des +8, Con +7",
		imunidades = "Fogo",
		sentidos = "Percepção Passiva 13",
		lingua = "Nenhuma",
		tracos = {
	...
	{
		nome = "Canibal Hitoku",
		tipo = "Besta Mágica Média, Caótico — Rank C+",
		cat = "PLAYTEST",
		vulneravelAAura = true,
		ca = "15 (Defesa Natural)",
		pv = "50 (5d12)",
		...
		sab = "20 (+5)",
		car = "16 (+3)",
		pericias = "Percepção +7, Furtividade +4, Intimidação +5",
		trs = "Con +6, Sab +7",
	...
	},
	{
		...
		sab = "18 (+4)",
		car = "22 (+6)",
		pericias = "+7 Atletismo, Investigação, Sobrevivência, Intuição, Percepção; +9 Intimidação",
		trs = "For +7, Car +7",
		imunidades = "Agarrado/Preso/Enredado, Impedido",
	...
	{
		nome = "Amakagame",
		tipo = "Aberração Imenso/Colossal, Neutro",
		cat = "ABERRAÇÃO",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "36 (6d10+4)",
		...
		sab = "14 (+2)",
		car = "5 (-3)",
		pericias = "Sobrevivência +5, Percepção +5",
		trs = "Con +7",
	...
	{
		nome = "Emperador Armorshell",
		tipo = "Besta Mágica Médio-Grande, Caótico/Maligno",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "26 (Defesa Natural)",
		pv = "64 (5d12+8)",
		desl = "9m",
		for_ = "18 (+4)",
		des = "1 (-5)",
		...
		sab = "10 (+0)",
		car = "10 (+0)",
		pericias = "Atletismo +7, Sobrevivência +3",
		trs = "For +7, Con +11",
	...
	{
		nome = "Hidra do Deserto",
		tipo = "Aberração Médio/Médio Modificado, Maligno",
		cat = "ABERRAÇÃO",
		vulneravelAAura = true,
		ca = "18 (Defesa Natural)",
		pv = "86 (8d8+21)",
		...
		sab = "15 (+2)",
		car = "10 (+0)",
		pericias = "Atletismo +6, Furtividade +8, Percepção +5",
		trs = "For +6, Des +8, Con +5",
		imunidades = "Sangramento",
	...
	{
		nome = "Fuzosheppu / Oogasumi",
		tipo = "Aberração Imenso/Colossal (mais leve que o ar), Neutro",
		cat = "ABERRAÇÃO",
		vulneravelAAura = true,
		ca = "12 (Defesa Natural)",
		pv = "10 (1d12+4) Camada Externa / 36 (6d10+4) Núcleo",
		desl = "15m de Voo",
		for_ = "5 (-3)",
		des = "5 (-3)",
		con = "18 (+4)",
		...
		sab = "14 (+2)",
		car = "5 (-3)",
		pericias = "Natureza +4, Sobrevivência +5",
		trs = "Con +7",
	...
	{
		nome = "Gogouge — Silkfang",
		tipo = "Besta Natural Enorme, Maligno — Próximo de Covil",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "17 (Defesa Natural)",
		pv = "127 (7d20+8)",
		...
		sab = "14 (+2)",
		car = "1 (+5)",
		pericias = "Atletismo +7, Intuição +5, Percepção +5, Sobrevivência +5",
		trs = "Des +9, Con +7, Sab +5",
		imunidades = "Veneno, Ácido",
		sentidos = "Visão no Escuro",
		lingua = "Desconhecida",
		tracos = {
	...
	{
		nome = "Hammerbeak (Bico de Martelo)",
		tipo = "Besta Mágica Média, Maligno",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "16 (Defesa Natural)",
		pv = "38 (5d8+3)",
		...
		sab = "15 (+2)",
		car = "11 (+0)",
		pericias = "+7 Esquiva e Esquiva Acrobática; +5 Percepção e Sobrevivência",
		trs = "Con +7, Sab +5",
		imunidades = "Caído, Atordoado por som ou impacto",
	...
	{
		nome = "Hanashirama",
		tipo = "Aberração Miúda, Neutra — Colônia de 10",
		cat = "ABERRAÇÃO",
		vulneravelAAura = true,
		ca = "22 (Defesa Natural)",
		pv = "2 (1d4-2)",
		desl = "9m de Nado",
		reacoes = "Ilimitadas (ao ser tocada ou mover)",
		for_ = "1 (-5)",
		des = "12 (+0)",
		con = "6 (-2)",
		int_ = "9 (-1)",
	...
	{
		nome = "Inbyos",
		tipo = "Monstruosidade Média, Mau — Bando de 3-5",
		cat = "MONSTRUOSIDADE",
		vulneravelAAura = true,
		ca = "16 (Defesa Natural)",
		pv = "34 (6d6+2)",
		desl = "9m (18m Transflorestal)",
		reacoes = "4",
		for_ = "18 (+4)",
		des = "18 (+4)",
		con = "14 (+2)",
		...
		sab = "15 (+2)",
		car = "10 (+0)",
		pericias = "Atletismo +7, Furtividade +7, Acrobacia +7, Percepção +5",
		trs = "For +7, Des +7",
	...
	{
		nome = "Kuongatari",
		tipo = "Besta Natural Miúdo, Neutro — Colônia de 10",
		cat = "BESTA NATURAL",
		vulneravelAAura = true,
		ca = "14 (Defesa Natural)",
		pv = "5 (1d6+1) cada / 50 (colônia completa)",
		desl = "6m",
		for_ = "7 (-2)",
		des = "16 (+3)",
		con = "12 (+1)",
		...
		sab = "10 (+0)",
		car = "3 (-4)",
		pericias = "Natureza +3, Percepção +3",
		trs = "Con +4, Sab +3",
	...
	{
		nome = "Madokajacks",
		tipo = "Besta Mágica Grande, Mau — Sozinho ou em Par",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "21 (Defesa Natural) / 18 (Membrana das asas)",
		pv = "56 (5d12+3)",
		desl = "15m Voo / 9m Terrestre",
		reacoes = "6",
		for_ = "20 (+5)",
		des = "20 (+5)",
		con = "15 (+2)",
		...
		sab = "17 (+3)",
		car = "10 (+0)",
		pericias = "Atletismo +8, Acrobacia +8, Intuição +5, Percepção +6",
		trs = "For +8, Des +8",
		imunidades = "Surdo",
		vulnerabilidades = "Luz.",
		lingua = "Desconhecida",
	...
	{
		nome = "Mandíbula Escarlate",
		tipo = "Besta Mágica Imenso/Colossal, Mau — Sozinho",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "25 (Defesa Natural)",
		pv = "255 (8d20+10)",
		desl = "27m de Voo (planando)",
		for_ = "30 (+10)",
		des = "18 (+4)",
		con = "30 (+10)",
		int_ = "10 (+0)",
		...
		trs = "For +13, Con +13",
		imunidades = "Surdo, Assustado/Intimidado, Exausto",
		sentidos = "Percepção às Cegas",
		lingua = "Desconhecida",
		tracos = {
			{ n = "Criatura de Cerco", d = "Dano crítico em construções e Constructos." },
	...
	{
		nome = "Nakikabane (Corpse Weeper / Lamentador de Cadáver)",
		tipo = "Besta Mágica Médio Modificado, Caótico/Mal — Próximo de Colônias",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "17 (Defesa Natural)",
		pv = "74 (10d10+24)",
		desl = "9m Terrestre / 21m Voo",
		reacoes = "6",
		for_ = "14 (+2)",
		des = "18 (+4)",
		con = "9 (-1)",
		...
		sab = "18 (+4)",
		car = "7 (-2)",
		pericias = "Atletismo +5, Acrobacia +7, Intuição +7",
		trs = "For +5, Des +7, Sab +7",
		imunidades = "Assustado",
		lingua = "Desconhecida",
		tracos = {
	...
	{
		nome = "Dragão Turbinódio — Ryuusazai",
		tipo = "Besta Mágica Imenso/Colossal, Mau — Sozinho",
		cat = "BESTA MÁGICA",
		vulneravelAAura = false,
		ca = "23 (Defesa Natural)",
		pv = "187 (9d20+30)",
		desl = "18m Terrestre",
		for_ = "30 (+10)",
		des = "17 (+3)",
		...
		sab = "26 (+8)",
		car = "10 (+0)",
		pericias = "Atletismo +13, Percepção +11",
		trs = "For +13, Sab +11",
		imunidades = "Assustado, Sangrando, Queimando, Atordoado",
		lingua = "Desconhecida",
		tracos = {
	...
	{
		nome = "Tamaugachi",
		tipo = "Monstruosidade Médio Modificado, Mau — Sozinho",
		cat = "MONSTRUOSIDADE",
		vulneravelAAura = true,
		ca = "18 (Defesa Natural)",
		pv = "86 (7d12+8)",
		...
		sab = "30 (+10)",
		car = "4 (-3)",
		pericias = "Atletismo +12, Acrobacia +10, Natureza +13, Percepção +13",
		trs = "Con +13, Sab +13",
		imunidades = "Cego, Surdo, Atordoado, Envenenado",
...
-- Indice por nome, pra busca rapida (mesmo padrao do ItemsDB.FindItem)
local porNome = {}
for _, m in ipairs(MonsterDB.Monstros) do
	porNome[m.nome] = m
end

function MonsterDB.FindMonster(nome)
	return porNome[nome]
end
